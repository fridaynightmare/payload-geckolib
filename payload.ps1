...
# 4. Inyección en Discord (CORREGIDO)
...
if($f){
    # Usamos comillas SIMPLES para que PowerShell NO toque el código JS
    ...
    # Concatenamos la URL limpia en medio de las dos partes de JS literal
